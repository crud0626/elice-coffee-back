...
const loginCheck = [idCheck, passwordCheck];
...
const resetpwCheck = [idCheck, body('email', 'Email 유효성 검증 오류').notEmpty().isEmail()];

const meCheck = [body('address', 'Address 유효성 검증 오류').notEmpty(), passwordCheck];
